...
void CLoad3DS::ProcessNextChunk(t3DModel *pModel, tChunk *pPreviousChunk)
{
	...
	while (pPreviousChunk->bytesRead < pPreviousChunk->length)
	{
		...
		case VERSION:							// This holds the version of the file
			...
			{
				XEVOL_LOG(eXL_DEBUG_HIGH, "This 3DS file is over version 3 so it may load incorrectly\n");
			}
			break;
...
void CLoad3DS::ReadUVCoordinates(t3DObject *pObject, tChunk *pPreviousChunk)
{
	...
	pObject->pTexVerts = new CModelVector2 [pObject->numTexVertex];
...
void CLoad3DS::ReadVertices(t3DObject *pObject, tChunk *pPreviousChunk)
{
	...
	pObject->pVerts = new CModelVector3 [pObject->numOfVerts];
	memset(pObject->pVerts, 0, sizeof(CModelVector3) * pObject->numOfVerts);
...
{
	CModelVector3 vVector1, vVector2, vNormal, vPoly[3];
	...
	for(int index = 0; index < pModel->numOfObjects; index++)
	{
		...
		CModelVector3 *pNormals		= new CModelVector3 [pObject->numOfFaces];
		CModelVector3 *pTempNormals	= new CModelVector3 [pObject->numOfFaces];
		pObject->pNormals		= new CModelVector3 [pObject->numOfVerts];
		...
		CModelVector3 vSum = {0.0, 0.0, 0.0};
		CModelVector3 vZero = vSum;
		int shared=0;
