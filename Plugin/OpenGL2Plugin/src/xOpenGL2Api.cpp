...
IRenderApiState* xGL2RenderApi::createRenderState(eRenderStateType _type)
{
      switch(_type)
      {
...
bool  xGL2RenderApi::drawRectf(IBaseTexture* pTexture, float vDestRect[4] , const xColor_4f& color)
{
...
bool xGL2RenderApi::drawRectf(IBaseTexture* pTexture, float vDestRect[4] ,float vSrcRect[4]  , const xColor_4f& color)
{
      setTexture(0 , pTexture);
      xvec4& dstRect =  *((xvec4*)vDestRect);
...
bool xGL2RenderApi::multiMatrix(const float* mat , eMatrixMode matMode)
{
      return m_MatrixCtx.multiMatrix( mat , matMode);
}

bool xGL2RenderApi::setMatrix(const float* mat   , eMatrixMode matMode)
{
