#ifndef _BOUNDBOX_HELPER_H_
#define _BOUNDBOX_HELPER_H_
...
class _XEVOL_PLUGIN_API_ xBoundBoxHelper : public IDrawableHelper
{
	...
	float            m_lenX;
	float            m_lenY;
	IMPL_BASE_OBJECT_INTERFACE(xBoundBoxHelper);
public:
	xBoundBoxHelper(IBaseRenderer* pRenderer, int arg);
	~xBoundBoxHelper();
