...
public:
     virtual IRenderEffect* effect(size_t idx = 0 )    = 0 ;
	 virtual bool           setEffect(IRenderEffect* _effect , size_t idx = 0) = 0 ;
	 ...
	 virtual bool           drawImm(IBaseRenderer* pRenderer, unsigned int passedTime , xGeomLib::xCamera* pCamera) = 0;
...
public:
	...
	virtual bool           setEffect(IRenderEffect* _effect , size_t idx = 0 ) ;
