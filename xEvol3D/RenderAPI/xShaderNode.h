...
//=================================================
typedef std::vector<xShaderCodeSection* , dllsafe_alloc<xShaderCodeSection*> > xShaderCodeSections;
typedef std::vector<xShaderNodeSocket * , dllsafe_alloc<xShaderNodeSocket *> > xShaderNodeSockets;
...
public:
	...
	virtual ds_wstring_vector&   importLibs();
	...
	virtual bool                 generateCode(std::ds_string& code , xShaderCodeNodeMgr* pNodeMgr);
