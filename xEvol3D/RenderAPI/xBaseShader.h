...
class _XEVOL_BASE_API_ IInputBufferReflection : public IBaseObject
{
public:
	IMPL_BASE_OBJECT_CLASSID_INTERFACE(IInputBufferReflection)
public:
    ...
    virtual void*                        systemBuffer() = 0;
	virtual void                         setDirty(bool bDirty = true) = 0;
};

class _XEVOL_BASE_API_  IShaderParamTable  : public IBaseObject
{
    IMPL_BASE_OBJECT_CLASSID_INTERFACE(IShaderParamTable)
public:
...
class _XEVOL_BASE_API_  IBaseShader : public IRenderApiResource
{
...
class _XEVOL_BASE_API_  IGpuProgramParamTable  : public IBaseObject
{
    IMPL_BASE_OBJECT_CLASSID_INTERFACE(IGpuProgramParamTable)
public:
...
class _XEVOL_BASE_API_  IGpuProgram : public IRenderApiResource
{
...
public:
	...
	PUBLIC virtual bool                    load(const wchar_t* fileName , unsigned long  arg) = 0;
	PUBLIC virtual bool                    load(const wchar_t* fileName , const unsigned int8* buf , size_t bufLen, unsigned long arg) = 0;
	PUBLIC virtual bool                    load(const wchar_t* vName[eShader_Max], unsigned long arg ) = 0;
	PUBLIC virtual bool                    isLoaded()  = 0;
	PUBLIC virtual bool                    unload() = 0;
	PUBLIC virtual unsigned long           memUsage() = 0;
	PUBLIC virtual eResourceType           res_type(){ return RESOURCE_SHADER ; }
