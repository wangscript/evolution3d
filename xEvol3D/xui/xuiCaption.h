...
#ifndef __XUI_CAPTION_H__
#define __XUI_CAPTION_H__
#include "xuiControl.h"

BEGIN_NAMESPACE_XUI
class _XEVOL_BASE_API_ xuiCaption : public xuiControl
{
    ds_wstring   m_text;
    xuiRegion    m_CloseBox;
public:
    xuiCaption(xuiWindow* parent, xuiWindowManager* pMgr);
    ~xuiCaption();
