...
protected:
	...
	virtual bool _preLoadResource(const std::ds_wstring& strResName   , XEvol3D::xXmlDocument* & pRes , int& ResSize, unsigned int arg) { return true ; }
	virtual bool _postLoadResource(const std::ds_wstring& strResName   , XEvol3D::xXmlDocument* & pRes , int& ResSize, unsigned int arg){ return true ; }
