...
// CExcel_Font wrapper class

class CExcel_Font : public COleDispatchDriver
{
public:
	CExcel_Font(){} // Calls COleDispatchDriver default constructor
	CExcel_Font(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcel_Font(const CExcel_Font& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
