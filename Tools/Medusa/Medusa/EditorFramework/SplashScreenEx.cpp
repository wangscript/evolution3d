...
BOOL CSplashScreenEx::Create(CWnd *pWndParent,LPCTSTR szText,DWORD dwTimeout,DWORD dwStyle)
{
	...
	HWND hParent = m_pWndParent ? m_pWndParent->m_hWnd : NULL;
	if (!CreateEx(WS_EX_TOOLWINDOW | WS_EX_TOPMOST,TEXT("SplashScreenExClass"),NULL,WS_POPUP,0,0,0,0,hParent,NULL))
		return FALSE;
