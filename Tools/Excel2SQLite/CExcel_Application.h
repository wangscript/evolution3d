...
// CExcel_Application wrapper class
#include <afxdisp.h>

class CExcel_Application : public COleDispatchDriver
{
public:
	CExcel_Application(){} // Calls COleDispatchDriver default constructor
	CExcel_Application(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcel_Application(const CExcel_Application& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
