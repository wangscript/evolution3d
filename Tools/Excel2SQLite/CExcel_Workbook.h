...
// CExcel_Workbook wrapper class
#include <afxdisp.h>
class CExcel_Workbook : public COleDispatchDriver
{
public:
	CExcel_Workbook(){} // Calls COleDispatchDriver default constructor
	CExcel_Workbook(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcel_Workbook(const CExcel_Workbook& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
