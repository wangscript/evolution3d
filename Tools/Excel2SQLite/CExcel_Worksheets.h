...
// CExcel_Worksheets wrapper class
#include <afxdisp.h>
class CExcel_Worksheets : public COleDispatchDriver
{
public:
	CExcel_Worksheets(){} // Calls COleDispatchDriver default constructor
	CExcel_Worksheets(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcel_Worksheets(const CExcel_Worksheets& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
