...
#include "RenderAPI/xShaderSemanticEnum.h"
	...
	{
	internal:
		IRenderApiObject* m_pRenderObject;
		xRenderObject(IRenderApiObject* pObject) { m_pRenderObject = pObject        ; }
	...
	{
	internal:
		IRenderApiResource* m_pResource;
		xRenderResource(IRenderApiResource* pResource) : m_pResource(pResource) {};
	...
	{
	internal:
		IRenderApiState* m_pState;
		xRenderState(IRenderApiState* pState):xRenderObject(pState) { m_pState = pState ; };
		~xRenderState() {}
	public:
