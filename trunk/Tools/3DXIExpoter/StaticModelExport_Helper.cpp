...
bool CStaticModelExporter::show_expeort_dlg()
{
   ...
   if(IDOK == dlg.DoModal())
   {
	   ...
	   m_fModelScale       = 1.0f/dlg.m_fScale;
       return true;
   }
   return false;
}

bool CStaticModelExporter::GetSaveFileName(wchar_t* file_name)
{
    OPENFILENAMEW ofn; 
...
wstring CStaticModelExporter::get_avialabale_mesh_name(std::wstring prefix, std::wstring name)
{
    wchar_t posfix[32];
