...
// CExcel_Range wrapper class
#include <afxdisp.h>
class CExcel_Range : public COleDispatchDriver
{
public:
	CExcel_Range(){} // Calls COleDispatchDriver default constructor
	CExcel_Range(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcel_Range(const CExcel_Range& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
