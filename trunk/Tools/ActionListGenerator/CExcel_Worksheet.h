...
// CExcel_Worksheet wrapper class
#include <afxdisp.h>
class CExcel_Worksheet : public COleDispatchDriver
{
public:
	CExcel_Worksheet(){} // Calls COleDispatchDriver default constructor
	CExcel_Worksheet(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcel_Worksheet(const CExcel_Worksheet& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
