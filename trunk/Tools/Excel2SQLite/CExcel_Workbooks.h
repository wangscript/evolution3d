...
// CExcel_Workbooks wrapper class
#include <afxdisp.h>
class CExcel_Workbooks : public COleDispatchDriver
{
public:
	CExcel_Workbooks(){} // Calls COleDispatchDriver default constructor
	CExcel_Workbooks(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CExcel_Workbooks(const CExcel_Workbooks& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
