...
//Insert Node Code Node= D:\SVN\Evol3D\xEvolEngine\bin\shader\d3d1x\lib\simple.fakehdr.hlsl
...
float4 main( PS_INPUT input) : SV_Target
{
   ...
   float4 Node_1_Ret = CM_FakeHDR(Node_0_Ret , input.Tex , DefaultSampler , DiffuseTexture);
