...
inline bool XEvol_UnicodeToLocale(const wchar_t* wcsIn , char* ansiOut , int len )//ansiFileName , 1024);
{
	WideCharToMultiByte(CP_ACP,0,wcsIn,wcslen(wcsIn) , ansiOut , len , NULL,NULL);
	return true;
}
...
public:                                   \
	...
	virtual int      KillObject()     { if(m_RefCount != 1)  m_RefCount = 0 ; delete this; return 0;  }; \
