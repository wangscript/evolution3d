...
namespace XEvol3DModel
{
    ...
    struct sMeshDesc_t
    {
        ...
        sSubMeshDesc_t m_SubMesh[1];   //这个Mesh包含的所有的SubMesh的信息．这是个变长的结构体
    };
    //=========================================================================================
    ...
    */
    ...
    typedef vector<sModelTexLayer> ModelTexLayers_t;
    ...
    typedef vector<sVector_t>  sVectors_t;
    typedef vector<sUVCoord_t> sUVCoords_t;
    typedef vector<sColor_t>   sColors_t;
    ...
    */
    typedef vector<sActionInfo_t> sActionInfos_t;
    ...
    typedef vector<int> sBoneIndexs_t;
    ...
    typedef vector<sBoneHiberarchy_t>  sBoneHiberarchys_t;
    //帧动画模型的数据结构
