...
typedef vector<sMaxActionInfo_t> MaxFrameActionInfos_t;
...
class CFrameAniModelExporter : public CModelBaseExportor
{
    ...
    typedef vector<FrameAniActionData_t> ActionDatas_t; 
...
protected:
    ...
    bool __export_header(wstring prefix,vector<wstring>& mesh_names);
    bool __export_mesh(wstring prefix,wstring mesh_name,CMaxMesh& mesh);
    bool __export_mesh_faceinfo(wstring prefix,wstring mesh_name,CMaxMesh& mesh);
    bool __export_mesh_action(wstring prefix,wstring mesh_name,CMaxMesh& mesh,int action_index);

    wstring __get_avialabale_mesh_name(wstring prefix, wstring name);
