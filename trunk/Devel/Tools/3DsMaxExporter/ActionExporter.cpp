...
bool CActionExporter::load_action_list(sActionInfos_t& actions,xcomdoc& comdoc , wstring action_list_name)
{
...
void CActionExporter::writeActionList(sActionInfos_t& actions, xcomdoc&  comdoc, wstring action_list_name)
{
...
void CActionExporter::export(CSkeletonExporter* pSkeleton, sActionInfos_t& actions, xcomdoc&  comdoc, wstring action_dir)
{
    ...
    for(size_t iAction = 0 ; iAction < actions.size() ; ++iAction)
    {
		...
		xcomdocstream* pactiondatastream = comdoc.create_stream((action_dir + action.m_Name).c_str(),xcddt_common,XCOMDOC_COMPRESS_BLEND);
...
void CActionExporter::export_xml(CSkeletonExporter* pSkeleton, sActionInfos_t& actions, xcomdoc&  comdoc, wstring action_dir)
{
