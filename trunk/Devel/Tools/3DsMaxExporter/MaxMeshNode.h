...
typedef vector<sMaxTexLayer> sMaxTexLayers_t;
...
struct sVeretIndex_t
{
	...
	bool operator == (sVeretIndex_t& rhv)
	{
...
typedef vector<sWeightedVertex_t> sWeightedVertexs_t;
typedef vector<sVeretIndex_t>     VertexIndexs_t;
typedef vector<sMaxMatrial_t>     Materials_t;
typedef vector<Mtl*>              StdMtls_t;
typedef vector<int>               UsedMapChannels_t;
typedef sFace_t*                  IndexBuffer_t;
typedef vector<IndexBuffer_t>     IndexBuffers_t;
typedef vector<NFace>             NormalFaces_t;
typedef vector<MaxNormal>         MaxNormals_t;
...
typedef vector<xMeshBone_t> xMeshBones_t;
...
private:
	...
	int      __insert_vertex_index(sVeretIndex_t& vi);
	...
	int      __add_smgrp_normal(const MaxNormal& max_normal);
