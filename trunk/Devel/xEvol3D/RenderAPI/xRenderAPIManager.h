...
public:
	...
	virtual IRenderApi*    createRenderApi(int hWnd         , unsigned long hDevice , int w  = 0, int h = 0 ) = 0;
	virtual IRenderApi*    createRenderApi(IWindow* pWindow , unsigned long hDevice , int w  = 0, int h = 0 ) = 0;
};
