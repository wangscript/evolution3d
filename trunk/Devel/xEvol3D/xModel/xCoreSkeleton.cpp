...
bool xCoreAction::load(xCfgNode* pCfgNode , xcomdoc& doc , const wchar_t* actionDir)
{
...
bool xCoreSkeleton::saveHiberarchy(xcomdocstream* boneinfo_stream)
{
	 ...
	 xCfgNode* pRootNode = _xml.insertNode(L"hiberarchy");
...
bool xCoreSkeleton::saveHiberarchy(xCfgNode* pRootNode , int rootindex)
{
