...
// 不换行式的输出一个区间内的文本
bool xFontRender::drawText(const wchar_t* strText, float x , float y , int iBgnIdx, int nCount, xColor_4f cl, int nMaxW /*= 0*/)
{
...
bool xFontRender::drawText(const wchar_t* strText, float x , float y , xColor_4f cl)
{
	int w , h ;
...
bool  xFontRender::drawTextOneLine(const wchar_t* strText, xMathLib::xvec4& rect, xColor_4f cl, eAlignMode hAlignMode , eAlignMode vAlignMode)
{
	int w , h ;
	getTextDim(strText,w , h );
