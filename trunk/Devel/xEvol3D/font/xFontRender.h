...
class _XEVOL_BASE_API_ xFontRender : public IRefCountObject
{
public:
	enum eAlignMode
	{
	...
	IMPL_REFCOUNT_OBJECT_INTERFACE(xFontRender);
public:
	xFontRender(): m_pRendeDevice(NULL){ m_RefCount = 0; }
	xFontRender(IFontRenderDevice* pRenderer){ m_RefCount = 1 ; m_pRendeDevice = pRenderer ;}
	virtual ~xFontRender(){}
