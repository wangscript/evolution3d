...
#ifndef __FIX_SMALL_MEM_ALLOC_H__
#define __FIX_SMALL_MEM_ALLOC_H__
...
{ 
	namespace Mem
	{
		...
		class  _XEVOL_BASE_API_  FixSmallMemAlloc
		{

			enum {MAX_POOL_NUM = MAX_SMALLMEM_SIZE};
