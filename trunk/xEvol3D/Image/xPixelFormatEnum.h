...
ENUMCLASS(enum)  ePIXEL_FORMAT
{
    ...
    PIXELFORMAT_DEPTH32S8UX24      = MAKEPIXEL_FORMAT( 64, 50), 


	//不可以操作的
	PIXELFORMAT_DXT1               = MAKEPIXEL_FORMAT( 32,  51), 
	PIXELFORMAT_DXT2               = MAKEPIXEL_FORMAT( 32,  52), 
	PIXELFORMAT_DXT3               = MAKEPIXEL_FORMAT( 32,  53), 
	PIXELFORMAT_DXT4               = MAKEPIXEL_FORMAT( 32,  54), 
	PIXELFORMAT_DXT5               = MAKEPIXEL_FORMAT( 32,  55), 


	//视频纹理的常见的三种格式。
	//其他的YUV格式目前不支持
	PIXELFORMAT_YV12               = MAKEPIXEL_FORMAT(12 , 56),
	PIXELFORMAT_YVY2               = MAKEPIXEL_FORMAT(16 , 57),
	PIXELFORMAT_AYUV               = MAKEPIXEL_FORMAT(32 , 58),
