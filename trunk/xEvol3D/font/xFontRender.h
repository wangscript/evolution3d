...
class  _XEVOL_BASE_API_ xFontRenderCreator;
struct xFontInfo
{
...
public:
      ...
      //¹«¹²º¯Êý
      virtual bool  drawText(const wchar_t* strText, float x , float y , int maxWidth , const xColor_4f& cl );
      virtual bool  drawText(const wchar_t* strText, float x , float y , const xColor_4f& cl );
      virtual bool  drawText(const wchar_t* strText, float x , float y , int iBgnIdx, int nCount, const xColor_4f& cl, int nMaxW = 0);
      bool          drawTextOneLine(const wchar_t* strText, xMathLib::xvec4& rect, const xColor_4f& cl, eAlignMode hAlignMode , eAlignMode vAlignMode);
...
public:
      ...
      template<typename T1 , typename T2> bool  drawText(const wchar_t* strText, T1 x , T2 y ,const xColor_4f& cl )
      {
            return drawText(strText , (float)x  ,  (float)y , cl);
      }

      template<typename T1 , typename T2 > bool  drawText(const wchar_t* strText, T1 x , T2 y ,  int iBgnIdx, int nCount, const xColor_4f& cl, int nMaxW = 0)
      {
...
DECL_OBJECT_FACTORY_AND_MGR(xFontRender ,xFontRenderCreator , xFontRenderCreatorMgr , xFontLoader* , int );
