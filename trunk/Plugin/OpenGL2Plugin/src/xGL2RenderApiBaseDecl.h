...
template <typename T> class TD3DRenderApiObjectTable
{
...
{
	TD3DRenderApiObjectTable<xGL2InputAssembler> m_InputAssemblerMgr;
	TD3DRenderApiObjectTable<IInputBuffer>       m_InputBufferMgr;
	TD3DRenderApiObjectTable<ILightingEnv>       m_LightStateMgr;
public:
	TD3DRenderApiObjectTable<xGL2InputAssembler>& inputAssemblerMgr(){return m_InputAssemblerMgr ; }
	TD3DRenderApiObjectTable<IInputBuffer>&       InputBufferMgr(){return m_InputBufferMgr ;}
	TD3DRenderApiObjectTable<ILightingEnv>&       LightEnvMgr(){return m_LightStateMgr ; }
};
